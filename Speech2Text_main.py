...
class Transcriber:
    ...
    def transcribe(self, path): #takes filepath of a 1-second wav file as input
        ...
        classify = self.model.predict(sound)
        prediction = np.argmax(classify)
        word = self.__getClass(prediction)
