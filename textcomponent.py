...
def tts(docs):
    ...
    tts.save('Recording/example.mp3')
    #get the mp3, return a playable file
    speech = vlc.MediaPlayer('Recording/example.mp3')
    return speech
    #speech.play() to play the file
    #speech.stop() to stop the playing
...
#testing grounds
#dataout = get_data('the idiot pt 1.docx')
#p = tts(dataout)
#word_count, result = extract_data(dataout)
#print(result)
#img = vis_data(word_count)
